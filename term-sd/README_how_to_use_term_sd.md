...
- [Tern-SD使用教程](#tern-sd使用教程-1)
  ...
  - [Term-SD安装功能](#term-sd安装功能)
    ...
    - [lora-scripts安装](#lora-scripts安装)
      ...
      - [4、安装确认](#4安装确认-2)
    - [kohya\_ss安装](#kohya_ss安装)
      - [1、安装镜像选项](#1安装镜像选项-6)
      - [2、PyTorch版本选择](#2pytorch版本选择-5)
  ...
  - [Term-SD设置](#term-sd设置)
    - [虚拟环境设置](#虚拟环境设置)
    - [Pip镜像源设置(配置文件)](#pip镜像源设置配置文件)
    - [Pip镜像源设置(环境变量)](#pip镜像源设置环境变量)
    - [Pip缓存清理](#pip缓存清理)
    - [代理设置](#代理设置)
    - [Github镜像源设置](#github镜像源设置)
    - [HuggingFace镜像源设置](#huggingface镜像源设置)
    - [命令执行监测设置](#命令执行监测设置)
    - [Term-SD安装模式](#term-sd安装模式)
    - [Aria2线程设置](#aria2线程设置)
    - [缓存重定向设置](#缓存重定向设置)
    - [CUDA内存分配设置](#cuda内存分配设置)
    - [自定义安装路径](#自定义安装路径)
    - [空间占用分析](#空间占用分析)
    - [网络连接测试](#网络连接测试)
    - [卸载Term-SD](#卸载term-sd)
  - [Term-SD额外功能](#term-sd额外功能)
    ...
    - [启动参数](#启动参数)
      - [启动参数的使用方法](#启动参数的使用方法)
      - [启动参数的功能解析](#启动参数的功能解析)
  - [安装 gperftools 内存优化](#安装-gperftools-内存优化)
  - [绘世启动器的使用](#绘世启动器的使用)
