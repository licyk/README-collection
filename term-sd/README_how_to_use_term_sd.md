...
>如果系统是Windows，则在安装完成之后，需要退出Term-SD，在Term-SD启动命令添加启动参数`--extra fix-bitsandbytes-for-kohya-ss-on-windows`，运行“fix-bitsandbytes-for-kohya-ss-on-windows”脚本来修复bitsandbytes报错问题
